...
--
-- Table structure for table `colorModel`
--

DROP TABLE IF EXISTS `colorModel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `color` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `colorModel`
--

LOCK TABLES `colorModel` WRITE;
...
--
-- Table structure for table `couponModel`
--

DROP TABLE IF EXISTS `couponModel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `coupon` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `couponModel`
--

LOCK TABLES `couponModel` WRITE;
/*!40000 ALTER TABLE `couponModel` DISABLE KEYS */;
INSERT INTO `coupon` VALUES (1,'couponModel mặc định','no_coupon','2018-07-31',0,0,'couponModel mặc định nhằm tránh sai dữ liệu',99983,'coupon_images/coupon_15.png'),(2,'Giảm 15% giá trị đơn hàng khi đặt hàng online','ONLINE_ORDER','2021-03-26',15,0,'Giam',100,'coupon_images/coupon_15_aQpeqU1.png'),(3,'Giảm 20% giá trị đơn hàng','ABCD_CODE2','2020-06-11',20,0,'',42,'coupon_images/coupon_15_6uruprs.png');
/*!40000 ALTER TABLE `couponModel` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `django_content_type` VALUES (6,'account','userModel'),(1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(22,'cart','cart'),(23,'cart','orderitem'),(24,'cart','orderpackage'),(21,'cart','orderpackagestatus'),(19,'contact_us','feedback'),(4,'contenttypes','contenttype'),(20,'couponModel','couponModel'),(27,'favourite','favourite'),(7,'mainapp','brand'),(18,'mainapp','cart'),(8,'mainapp','categoryModel'),(9,'mainapp','colorModel'),(10,'mainapp','couponModel'),(11,'mainapp','detailshoe'),(17,'mainapp','favourite'),(16,'mainapp','image'),(15,'mainapp','orderitem'),(14,'mainapp','orderpackage'),(12,'mainapp','orderpackagestatus'),(13,'mainapp','shoe'),(26,'order','orderitem'),(25,'order','orderpackage'),(5,'sessions','session');
