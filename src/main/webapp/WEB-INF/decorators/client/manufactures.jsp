...
-->
<div class="container"> <!-- end in footer -->
    <div id="gototop"></div>
    <header id="header">
        <div class="row">
            <div class="span4">
                <h1>
                    <a class="logo" href="index.html"><span>Twitter Bootstrap ecommerce template</span>
                        <img src="/img/logo.png" alt="bootstrap sexy shop">
                    </a>
                </h1>
            </div>
        ...
        <div id="sidebar" class="span3">
            <div class="well well-small">
                <ul class="nav nav-list">
                    ...
                    <li><a href="/categories/1"><span class="icon-chevron-right"></span>Giày da</a></li>

                    <li><a href="/categories/2"><span class="icon-chevron-right"></span>Giày lười</a></li>

                    <li><a href="/categories/3"><span class="icon-chevron-right"></span>Giày thể thao</a></li>

                    <li><a href="/categories/4"><span class="icon-chevron-right"></span>Giày cao cổ</a></li>

                    <li><a href="/categories/5"><span class="icon-chevron-right"></span>Giày vải</a></li>

                    <li><a href="/categories/6"><span class="icon-chevron-right"></span>Giày bata</a></li>


                    <li><a href="/categories/"><span class="icon-chevron-right"></span>Xem all</a></li>
...
<div class="copyright">
    <div class="container">
        <p class="pull-right">
            <a href="#"><img src="/static/img/maestro.png" alt="payment"></a>
            <a href="#"><img src="/static/img/mc.png" alt="payment"></a>
            <a href="#"><img src="/static/img/pp.png" alt="payment"></a>
            <a href="#"><img src="/static/img/visa.png" alt="payment"></a>
            <a href="#"><img src="/static/img/disc.png" alt="payment"></a>
        </p>
